...
<div class="col-lg-4">
    <div class="panel panel-default" id="fullform">
        <div class="header" style="overflow: hidden; padding: 15px">
        	<div style="float: left">
	            <b><?php echo $this->session->userdata('ussr_') ;?></b> needs to change the password...
	        </div>
	        <div style="float: right">
	        	<a href="<?php echo site_url('admin/member');?>">
		        	<span class="pe-7s-close-circle" style="font-size: 24px; color: #ff0000;"></span>
		        </a>
	        </div>
