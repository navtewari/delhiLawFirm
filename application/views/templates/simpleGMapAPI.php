 ...
 */
$this->load->view('templates/simpleGMapGeocoder');
...
function printGMapsJS()
{
    ...
    echo "\n<script src=\"http://maps.google.com/maps/api/js?v=3.exp&key=AIzaSyBF4O-qyKNuV64-ckt3XmIVSjz2bQguHKI&sensor=$_sensor\" type=\"text/javascript\"></script>\n";
}
